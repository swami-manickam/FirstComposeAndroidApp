package com.mycompose.android.presentation.custom
...
class StoragePermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            "It seems you permanently declined file storage permission. " +
                    "You can go to the app settings to grant it."
        } else {
            "This app needs file storage permission so that you can talk " +
                    "to your friends."
        }
    }
}