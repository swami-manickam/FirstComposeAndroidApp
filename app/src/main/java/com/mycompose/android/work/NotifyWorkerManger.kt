package com.mycompose.android.work
...
import com.mycompose.android.presentation.MainActivity
import com.mycompose.android.utils.extension.vectorToBitmap
import com.mycompose.app.R


class NotifyWorkerManger(context: Context, params : WorkerParameters) : Worker(context, params) {
    ...
    private fun sendNotification(id: Int) {
        ...
        val notification = NotificationCompat.Builder(applicationContext, NOTIFICATION_CHANNEL)
            .setLargeIcon(bitmap).setSmallIcon(R.drawable.ic_schedule_black)
